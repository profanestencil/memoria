---
name: Memory Archive Mobile Webapp
overview: Plan for a mobile-first webapp that captures photos with location, mints them as NFTs on Base (with Privy wallets), displays pins on a Mapbox map, and opens a geo-anchored AR view to view the photo at its real-world location using WebXR/Three.js with GPS+compass-based placement.
todos: []
isProject: false
---
...
No code or repo changes are made in this step; this plan is for implementation in a follow-up phase.